...
export function Birthday() {
  return (
    <Letter theme="birthday">
      <div className="min-h-screen w-screen px-4 sm:px-6 md:px-8 lg:px-12 py-10 sm:py-12 md:py-14 lg:py-16 relative bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 flex items-center justify-center">
