...
export function Home() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-rose-50 to-purple-50 px-3 sm:px-6 md:px-8 py-8 sm:py-12 md:py-14 lg:py-16">
      <div className="w-full max-w-3xl mx-auto flex flex-col justify-center items-center py-2 sm:py-4">
        {/* Header */}
        <div className="text-center mb-8 sm:mb-10 md:mb-12 space-y-2 sm:space-y-3 md:space-y-4">
          <h1
        ...
        {/* Letter Cards */}
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8 place-items-center mb-8 sm:mb-10 w-full px-4 max-w-5xl">
          {letters.map((letter) => (
            <Link
              key={letter.path}
              to={letter.path}
            ...
            >
              <div className="text-center space-y-2 sm:space-y-3 md:space-y-4 relative z-10">
                <div className={`text-4xl sm:text-5xl md:text-5xl lg:text-6xl mb-2 sm:mb-3 flex items-center justify-center ${letter.iconColor} ${letter.iconHoverColor} transition-all duration-500 group-hover:scale-125 group-hover:rotate-12 drop-shadow-lg`}>
                  <letter.icon />
                </div>
                <h2
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 -translate-x-full group-hover:translate-x-full" style={{ transform: "skewX(-20deg)" }}></div>
            </Link>
          ))}
        </div>

        {/* Footer */}
        <div className="text-center px-3 sm:px-4 pt-8 sm:pt-12 max-w-lg">
          <p
